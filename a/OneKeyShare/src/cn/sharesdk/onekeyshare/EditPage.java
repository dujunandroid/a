...
public class EditPage extends FakeActivity implements OnClickListener,
	...
	private void initPageView() {
		...
		if (resId > 0) {
			llTitle.setBackgroundColor(Color.parseColor("#fc4a00"));
		}
		...
		if (!TextUtils.isEmpty(imagePath) && new File(imagePath).exists()) {
			...
			initImage(llInput);
		} else if (!TextUtils.isEmpty(viewToShare)
				&& new File(viewToShare).exists()) {
			try {
				shareImage = true;
	...
	public void onClick(View v) {
		...
		if (v.equals(llTitle.getBtnRight())) {
			...
			if (selected) {
				if (parent != null) {
					parent.setCallback(new OneKeyShareCallback1());
	...
	public boolean handleMessage(Message msg) {
		...
		case MSG_AFTER_IMAGE_DOWNLOAD:
			...
			break;
		case 3:
			Toast.makeText(getContext(),getStringRes(activity, "share_completed"), Toast.LENGTH_SHORT).show();
			break;
		case 0:
			Toast.makeText(getContext(),
					getStringRes(activity, "share_canceled"),
					Toast.LENGTH_SHORT).show();
			break;
		case -1:
			Toast.makeText(getContext(),
					getStringRes(activity, "share_failed"), Toast.LENGTH_SHORT)
					.show();
			break;
		}
		return false;
	...
	class OneKeyShareCallback1 implements PlatformActionListener {

		@Override
		public void onCancel(Platform arg0, int arg1) {
			UIHandler.sendEmptyMessage(0, EditPage.this);
		}

		@Override
		public void onComplete(Platform arg0, int arg1,
				HashMap<String, Object> arg2) {
			UIHandler.sendEmptyMessage(3, EditPage.this);
		}
