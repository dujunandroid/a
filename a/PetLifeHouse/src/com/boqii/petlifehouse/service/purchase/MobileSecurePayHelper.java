...
public class MobileSecurePayHelper {
	...
	public boolean detectMobile_sp() {
		...
		if (!isMobile_spExist) {
			...
			//
			// 捆绑安装
			retrieveApkFromAssets(mContext, "alipay_plugin.apk", cachePath);

			mProgress = BaseHelper.showProgress(mContext, null, mContext.getString(R.string.alipay_tips),
					false, true);
...
//					PackageInfo apkInfo = getApkInfo(mContext, cachePath);
	...
	public void showInstallConfirmDialog(final Context context,
		...
		tDialog.setPositiveButton(R.string.sure,
