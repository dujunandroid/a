...
import com.boqii.petlifehouse.activities.MyTicketListActivity;
				...
				if (list != null && list.size() > arg2 - 1) {
					...
					case 3:		
						...
						if(o.TicketNumber==1){							
							...
							startActivity(new Intent(getActivity(), MyTicketListActivity.class).putExtra("ORDERID", o.OrderId));
						}						
						break;
					case 4:
					case 5:
