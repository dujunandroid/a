...
public class Constants {
	public static String PATH = /*Environment.getExternalStorageState() + */ Environment.getExternalStorageDirectory().getPath() + "/boqii/pics";//图片存放路径
	public static String CODE = "comboqiiwwwvetapp";
	
	public static String AlipayLoginUrl = Config.DEBUG ? "http://shoptest.boqii.com/passport.php?System=App" : "http://shop.boqii.com/passport.php?System=App";
