...
public class MyCouponActivity extends BaseFragmentActivity implements OnClickListener {

	private FragmentManager fragmentManager;
	private FragmentTransaction transaction;
	private MyCouponFragment unusedFragment, usedFragment, outoftimeFragment;
	...
	private void setMyTabHost(int index){
		...
		case 1:
			...
			if(unusedFragment == null){
				unusedFragment = new MyCouponFragment();
		...
		case 2:
			...
			if(usedFragment == null){
				usedFragment = new MyCouponFragment();
		...
		case 3:
			...
			if(outoftimeFragment == null){
				outoftimeFragment = new MyCouponFragment();
